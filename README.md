...
## 📌 Overview
This project presents a deep learning–based approach for automated **Diabetic Retinopathy (DR) detection** using transfer learning with the EfficientNet-B0 architecture.  
The model classifies retinal fundus images into two categories:
